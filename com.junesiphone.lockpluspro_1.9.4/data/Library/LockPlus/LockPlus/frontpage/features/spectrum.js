...
//june
function changeInputColor(f){
    var colorPrompt = prompt("Enter color");
    if(colorPrompt){
        currentElement.spectrum("set", colorPrompt);
    }
}
...
(function (factory) {
    ...
    var defaultOpts = {
        ...
        markup = (function () {
            ...
            return [
                ...
                "<div onclick='changeInputColor()' style='color:white;'>Input Color</div>", //june
                "<input class='sp-input' type='text' style='pointer-events:none;' spellcheck='false'  />",
                "</div>",
    ...
    function spectrum(element, o) {
        ...
        function show() {
            ...
            currentElement = boundElement; //june

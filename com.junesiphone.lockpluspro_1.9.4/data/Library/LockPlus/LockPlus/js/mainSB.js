...
action.remakeDIV = function (id) {
    ...
    div.id = id;
    console.log(id);
    if (id !== 'durationbar' && id !== 'batterypie' && id.substring(0, 9) !== 'customDiv' && id !== 'avatarImage' && id !== 'icon' && id !== 'day1icon' && id !== 'day2icon' && id !== 'day3icon' && id !== 'day4icon' && id !== 'day5icon' && id !== 'searchicon' &&  id !== 'songalbumArtnohide' && id !== 'songalbumArt' && id !== 'searchtext' && id !== 'unlock' && id !== 'flashlight' && id !== 'playmusic' && id !== 'nextmusic' && id !== 'prevmusic' && id !== 'playmusichide' && id !== 'nextmusichide' && id !== 'prevmusichide' && id.substring(0, 4) !== 'text' && id.substring(0, 3) !== 'box' && id.substring(0, 3) !== 'tri' && id.substring(0, 3) !== 'app'&& id !== 'hour1icon' && id !== 'hour2icon' && id !== 'hour3icon' && id !== 'hour4icon' && id !== 'hour5icon') {
...
var loadexjsfile = function (id, over) {
    var link = 'https://lockplus.us/creator/widgets/' + id + '.js?' + (new Date()).getTime();
    var fileref = document.createElement('script');
    fileref.setAttribute("type", "text/javascript");
    ...
    Object.keys(this.savedElements.placedElements).forEach(function (key) {
        if (action.savedElements.placedElements[key].type == 'widget') {
            ...
            Object.keys(value).forEach(function (skey) { //loop styles on the object
                ...
                if (key === 'icon' || key === 'day1icon' || key === 'day2icon' || key === 'day3icon' || key === 'day4icon' || key === 'day5icon' || key === 'hour1icon' || key === 'hour2icon' || key === 'hour3icon' || key === 'hour4icon' || key === 'hour5icon') { //resize img inside #icon
